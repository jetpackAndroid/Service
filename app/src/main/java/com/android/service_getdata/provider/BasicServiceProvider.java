...
public class BasicServiceProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.android.service_getdata.provider.BasicServiceProvider";
