 ...
 */
public class IncomingSmsHandler extends ContentObserver {
     ...
     */
    public IncomingSmsHandler(Handler handler, ContentResolver contentResolver) {
        super(handler);
    ...
    public void onChange(boolean selfChange) {
        ...
        if (cursor.moveToNext()) {
            ...
            if (protocol != null || type != Telephony.TextBasedSmsColumns.MESSAGE_TYPE_INBOX) {
